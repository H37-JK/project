...
const LoginPage = () =>  {
    ...
    const handleGithubLogin = () => {
        window.location.href = `${process.env.NEXT_PUBLIC_API_URL}/login/github`;
    }
        ...
        <>
            <div className="background-gradient flex flex-1 justify-center items-center">
                <div className="flex flex-col space-y-4">
                    ...
                    <button onClick={() => handleGithubLogin()} className="flex items-center px-24 py-8 bg-gray-800 cursor-pointer text-white rounded space-x-3 text-xl font-bold">
